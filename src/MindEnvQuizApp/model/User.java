...
public class User {
    ...
    public String getArchetypeDescription() {
        if (totalScore >= 43) {
            ...
            return "Tempat yang tenang dan sudah lama kamu kenal membuatmu merasa nyaman. Namun sesekali, cobalah untuk keluar sebentar untuk melihat indahnya alam yang bisa menyegarkan pikiranmu.";
        }
    }    
   //quotes
